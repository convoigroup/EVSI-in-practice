...
rm("AE.l1.t1","AE.l1.t2","AE.l2.t1","AE.l2.t2","c.ae","c.dist","c.l2","c.l3","c.Mat.t1",
   ...
   "u.l1.withdraw.ae","u.l2","u.l3","u.Mat","With.AE.l1.t1",
...
#source("C:/Users/anna heath/OneDrive/OneDrive - SickKids/EVSI Methods/predict_ga.R")
...
uncert<-200
EVSI.Jalal.uncert<-foreach(i=1:(uncert),.combine=rbind,
                             .export=c("u.l1.noae","u.l1.withdraw.noae",
                                       "sig.X.noae",
                                       "sig.X.with","betaPar","INB",
                                       "n.","N",
                                       "filein","r.u.l1.noae","r.u.l1.withdraw.noae",
                                       "s.u.l1.noae","s.u.l1.withdraw.noae","Size.Outer","Size.Inner",
                                       "parameters.to.save","predict.ga"),
                            .packages=c("rjags","R2OpenBUGS","mgcv")) %dopar% {
...
stopCluster(cl)
write.table(EVSI.Jalal.uncert,"/home/aheath/Chronic_Pain/EVSIJalal.txt")